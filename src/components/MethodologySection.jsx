...
import { Users, Zap, Gauge, Eye, BarChart3, ArrowDown } from "lucide-react";

const MethodologySection = () => {
  return (
    <section className="flex flex-col gap-16 bg-primary/70 p-4 sm:p-8 lg:p-16" id="metodologia">
      <div>
        {/* Hat */}
      ...
      <div>
        {/* Cards */}
        <div className="mt-6 grid w-full gap-6 grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
          <MethodologyCard
