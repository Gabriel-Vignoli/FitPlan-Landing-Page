const MethodologyCard = ({ icon, title, description }) => {
  return (
    <div className="col-span-3 flex h-full w-full flex-col items-center gap-6 overflow-hidden rounded-3xl border border-white/10 bg-black/90 p-6 shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
      {/* Icon Container */}
